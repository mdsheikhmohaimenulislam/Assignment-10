...
useEffect(() => {
  fetch(`https://mango-server-seven.vercel.app/plants?searchParams=${search}&sort=${sortOrder}`)
    .then((res) => res.json())
    .then((data) => {
      setPlants(data);
    });
  document.title = "All Plants";
}, [search, sortOrder]); // re-fetch when sort changes

  return (
    <>
<div className="flex justify-center mt-10 gap-4 items-center">
  {/* Search input */}
  <div className="input mb-10 flex mx-auto">
    <svg
